...
shinyServer(function(input, output,session) {
  #WFO-TAMC######################
################################################Client Information###################  
  output$ClientSummary <- renderText({
  ...
  observe({
    session$sendCustomMessage(type = 'testmessage',
                              message = cat("You can set the data range and determine wether part of point or all of them need to be plot. also, you can run a report directly"))
  })
